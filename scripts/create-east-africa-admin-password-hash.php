...
/**
 * One-shot helper for East Africa Admin runtime initialization.
...
if (strlen($password) < 12) {
    fail_with_cleanup('EA admin password is shorter than 12 characters.');
}
...
fwrite(STDOUT, "EA admin password hash created and verified.\n");
